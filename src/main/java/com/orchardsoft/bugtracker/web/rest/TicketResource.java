...
import com.orchardsoft.bugtracker.domain.Ticket;
import com.orchardsoft.bugtracker.repository.TicketRepository;
...
/**
 * REST controller for managing {@link com.orchardsoft.bugtracker.domain.Ticket}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TicketResource {
    ...
    /**
     *  {@code GET /tickets/self} : get tickets assigned to the user
     *
     *  @param pageable the pagination information.
     *  @param eagerload flag to eager load entities from relationships (This is applicable for many-to-many).
     *  @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of tickets in body.
